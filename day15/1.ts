...
const solution = (input: string, row: number) => {
  ...
  return notIntersectedSegments.reduce(
    (a, b) => a + b[1] - b[0] + 1 - beaconsInSegment(b),
    0
  )
}

console.log(solution(getDemoInput(), 9))
console.log(solution(getDemoInput(), 10))
console.log(solution(getDemoInput(), 11))
console.log(solution(getInput(), 2000000))
